...
public class VariantContextUtils {
  ...
  public static boolean onAutosome(VariantGeneRecord variantGeneRecord) {
    String contigId = variantGeneRecord.getContig();
    return contigId != null && ContigUtils.isAutosome(contigId);
  }

  public static boolean onChromosomeX(VariantGeneRecord variantGeneRecord) {
    String contigId = variantGeneRecord.getContig();
    return contigId != null && ContigUtils.isChromosomeX(contigId);
  }

  public static boolean onChromosomeMt(VariantGeneRecord variantGeneRecord) {
    String contigId = variantGeneRecord.getContig();
    return contigId != null && ContigUtils.isChromosomeMt(contigId);
  }

  public static boolean onChromosomeY(VariantGeneRecord variantGeneRecord) {
    String contigId = variantGeneRecord.getContig();
    return contigId != null && ContigUtils.isChromosomeY(contigId);
  }

  public static Set<Allele> getAltAlleles(VariantGeneRecord variantGeneRecord, Pedigree pedigree){
