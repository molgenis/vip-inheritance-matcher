...
public class Genotype {
  ...
  public boolean isHom(Allele allele) {
    return originalGenotype.isCalled()
        && originalGenotype.isHom()
        && allele.equals(originalGenotype.getAllele(0));
  }
  ...
  public @Nullable String getPhasingBlock() {
    return originalGenotype.getExtendedAttribute(PHASING_BLOCK) != null
        ? originalGenotype.getExtendedAttribute(PHASING_BLOCK).toString()
        : null;
  }
}
