...
public class VcfReader implements AutoCloseable {
  ...
  @Getter private final VcfRecordFactory vcfRecordFactory;
  private final Set<String> pathogenicClasses;

  public VcfReader(
      VCFFileReader vcfFileReader,
      VcfRecordFactory vcfRecordFactory,
  ...
  public Stream<VcfRecord> stream() {
    return StreamSupport.stream(vcfFileReader.spliterator(), false)
        .map(vc -> vcfRecordFactory.create(vc, pathogenicClasses));
  }
