...
class VepMetadataTest {
  ...
  void setUp() {
    ...
    vepMetadata = new VepMetadata(header, fieldMetadataService);
  }
  ...
  void getGenes() {
    ...
    VcfRecordGenes expected = VcfRecordGenes.builder()
    ...
    VcfRecord vcfRecord = new VcfRecord(vc, vepMetadata, emptySet());
    assertEquals(expected, vcfRecord.getVcfRecordGenes());
  }
  ...
  void getGenesEmptyValues() {
    ...
    VcfRecordGenes expected = VcfRecordGenes.builder().containsVcWithoutGene(true).genes(Map
    ...
    VcfRecord vcfRecord = new VcfRecord(vc2, vepMetadata, emptySet());
    assertEquals(expected, vcfRecord.getVcfRecordGenes());
  }
  ...
  void getGenesEmptySymbolSource() {
    ...
    VcfRecord vcfRecord = new VcfRecord(variantContext, vepMetadata, emptySet());
    assertEquals(VcfRecordGenes.builder().genes(Map.of()).containsVcWithoutGene(true).build(), vcfRecord.getVcfRecordGenes());
  }
}