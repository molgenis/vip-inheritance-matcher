...
class VepMapperTest {
  ...
  void setUp() {
    ...
    when(vc.getAttributeAsStringList("CSQ", "")).thenReturn(Arrays.asList(
        ...
        "T|missense_variant|MODERATE|TEST2|ENSG00000123458|Transcript|ENST00000377205|protein_coding|5/5||ENST00000377205.1:c.619C>T|ENSP00000366410.1:p.Arg207Trp|763|619|207|R/W|Cgg/Tgg|||1||HGNC|17877||XR&XD|Leber_congenital_amaurosis_9:AR|"));
  ...
  void getGeneInheritanceMap() {
    ...
    expected.put("ENSG00000123457", Set.of(XD, XR));
    expected.put("ENSG00000123458", Set.of(XD, XR));
