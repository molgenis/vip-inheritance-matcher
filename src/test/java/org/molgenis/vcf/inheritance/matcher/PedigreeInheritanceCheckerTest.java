...
class PedigreeInheritanceCheckerTest {
  ...
  @Mock XldChecker xldChecker;
  @Mock XlrChecker xlrChecker;
  @Mock AdChecker adChecker;
  @Mock AdNonPenetranceChecker adNonPenetranceChecker;
  @Mock ArChecker arChecker;
  @Mock YlChecker ylChecker;
  @Mock MtChecker mtChecker;
  ...
  void setUp() {
    pedigreeInheritanceChecker =
        new PedigreeInheritanceChecker(
            xldChecker,
            xlrChecker,
            adChecker,
  ...
  void testAdPotential() {
    ...
    VcfRecord vcfRecord =
        new VcfRecord(
            vc,
            Set.of(Allele.ALT_A, Allele.ALT_G),
            Set.of(new GeneInfo("", "", Set.of(InheritanceMode.AD_IP))));
